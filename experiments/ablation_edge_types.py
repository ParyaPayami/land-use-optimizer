...
def run_edge_ablation(
    ...
    configurations = {
        ...
        'all_edges_no_physics': ['spatial_adjacency', 'visual_connectivity', 'functional_similarity', 
                                 'infrastructure', 'regulatory_coupling'],
    ...
    for config_name, edge_types in configurations.items():
        ...
        try:
            ...
            if config_name == 'all_edges_no_physics':
                history_physics = system.train_with_physics_feedback(num_epochs=physics_epochs, physics_weight=0.0)
            else:
